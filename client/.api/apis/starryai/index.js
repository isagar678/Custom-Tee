...
var SDK = /** @class */ (function () {
    function SDK() {
        ...
        this.core = new core_1.default(this.spec, 'starryai/1.0.0 (api/6.1.2)');
    }
    /**
     ...
     *
     */
    SDK.prototype.get_api_user_data_user__get = function () {
     ...
     */
    SDK.prototype.get_creations_creations__get = function (metadata) {
     ...
     */
    SDK.prototype.new_creation_creations__post = function (body) {
     ...
     */
    SDK.prototype.get_creation_creations__creation_id__get = function (metadata) {
